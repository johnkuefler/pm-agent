...
function buildIndicatorReport(state = {}, now = new Date()) {
  ...
  const indicators = [
    ...
    },
    {
      ...
      mechanism: 'Opt-in scheduled, tool-free language-model pulses over committed endogenous packets; explicit predecessor transitions, replayable hash-chain provenance, anti-rumination suppression, workspace competition, cost limits, and independent useful/misleading resolution.',
