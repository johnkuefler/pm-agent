...
test('the complete HTTP route surface remains registered in the same order', () => {
  ...
  // 448 to 468: the project control plane. 468 to 469: the on-demand research annex.
  ...
  assert.equal(expected.length, 469, 'route fixture should cover the complete known API surface');
