...
test('autonomic loop spans orientation, continuity, judgment, evidence, and closure', () => {
  ...
  assert.match(server, /createSlackCommunicationMirror[\s\S]*onToolSuccess: event => communicationMirror\.observeTool/);
  ...
  assert.match(server,
    /scheduleRecurringRuntimeJob\('operational-recovery-cycle'[\s\S]*?tickEndogenousRuntimeWithDiagnostics\(trigger\)/);
